                ...
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown user">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="${login.get(0).getHeadUrl()}"  style="width:28px;"/>                    
                            <i class="icon-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu">
                            <li><a href="#passwordModal" data-toggle="modal"><i class="icon-key"></i>&nbsp;&nbsp;&nbsp;密码修改</a></li>
                            <li><a href="com.Manager.Home/LoginOut"><i class="icon-off"></i>&nbsp;&nbsp;&nbsp;退出</a></li>
                        </ul>
        ...
        <div class="page-sidebar nav-collapse collapse" style="left: 0">
            <ul id="menuall" class="page-sidebar-menu">
                ...
                <li id="menupage6">
                    <a href="javascript:;">
                        <i class="icon-book"></i>
                        <span class="title">通讯管理</span>
                        <span class="arrow "></span>
                    </a>
                    <ul class="sub-menu">
                        <li id="menupage6_6">
                            <a href="/Manager/com.Manager.Communication/ContactList">通讯录管理</a>
                        </li>
                        <li id="menupage6_0">
                    ...
                    <ul class="sub-menu">
                        <li id="menupage5_2">
                            <a href="Individual/Arrangement.jsp?active=menupage5_2">日程安排</a>
                        </li>
                        <li id="menupage5_1">
                            <a href="">工作记录</a>
                        </li>
                         <li id="menupage5_0">
                            <a href="Individual/personal_info.jsp?active=menupage5_0">个人信息管理</a>
                        </li>
                        <!-- <li id="menupage5_1">

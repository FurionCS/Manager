...
public class StringUtil {
	...
	public static final String _LOCAL_OS_NAME = getOSName();
	...
	public static String chgGBK(String value) {
		if (value == null || value.equals("")) {
			...
			try {
				if (_LOCAL_OS_NAME.startsWith("windows")) {
	 ...
	 * @return
	 */
	public static String chgUTF8(String value) {
		if (value == null || value.equals("")) {
			return "";
		} else {
			try {
	 ...
	 * @param defalut
	 *            整型字符串
	 * @return 整型数字，如果字符串非法，返回默认值
	 */
	public static int toInteger(String value, int defalut) {
		try {
			return Integer.valueOf(value).intValue();
		} catch (Exception e) {
			return defalut;
	 ...
	 * @param value
	 *            待转化的浮点型字符串
	 * @return 浮点型数字，如果字符串非法，返回默认值
	 */
	public static float toFloat(String value, float defalut) {
		try {
			return Float.valueOf(value).floatValue();
		} catch (Exception e) {
			return defalut;
	 ...
	 * @param value
	 *            待转化的双精度数字字符串
	 * @return 双精度数字，如果字符串非法，返回默认值
	 */
	public static double toDouble(String value, double defalut) {
		try {
			return Double.valueOf(value).doubleValue();
		} catch (Exception e) {
			return defalut;
	...
	public static void main(String[] args) {
		...
		String s = "滴滴嗒嗒打发掉Aadddf（×（8902{param1}DFDFASFDAddDE1地地道道宕{param2}ddfdfa{param1}";
